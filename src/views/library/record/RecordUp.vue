...
import { addmsg } from '@/server/db/request.js'
...
const rule = reactive({
  ...
  bookNum: [{ required: true, message: '请输入图书总数量', trigger: 'blur' }],
